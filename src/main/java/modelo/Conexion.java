...
public class Conexion {
    ...
    public static Connection getConexion() {
        ...
        if (produccion == false) {
            String url = "jdbc:sqlserver://DESKTOP-3CPB4UK\\MSSQLSERVER:1433;databaseName=Cofebd";
            try {
            ...
            String url = "jdbc:sqlserver://CAFEAPROSEM\\MSSQLSERVER:1433;databaseName=Cofebd";
            try {
                Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
            } catch (ClassNotFoundException e) {
                JOptionPane.showConfirmDialog(null, "No se pudo establecer" + e.getMessage(), "Error de Conexion", JOptionPane.ERROR_MESSAGE);
