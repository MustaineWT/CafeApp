...
public class LPAContable {
    ...
    public LPAContable(int idlpacontable, int idempresa, int idsucursal, int idpersona, int ejercicio, double cpinicial, double ftinicial, double rainfinicial, double convinicial, String estado) {
