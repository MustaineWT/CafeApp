...
public class ControladorCrudBuscar implements ActionListener, MouseListener, KeyListener {
        ...
        if (e.getSource() == vistaCRUD.btnSeleccionar) {
            ...
            try {
                ...
                if (filaseleccionada == -1) {
                    ...
                    String nom = (String) modelotabla.getValueAt(filaseleccionada, 5);
                    String ape = (String) modelotabla.getValueAt(filaseleccionada, 6);
                    ...
                    controlaC.vistaCRUD.txtIdProLPACon.setText(id);
                    controlaC.vistaCRUD.txtNomLPACon.setText(nom+" "+ape);
                    vistaCRUD.dispose();
                }
    ...
    private void construirTabla(String[] titulos, Object[][] data) {
        ...
        vistaCRUD.jtProBuscador.getColumnModel().getColumn(12).setCellRenderer(new GestionCeldas("texto"));
