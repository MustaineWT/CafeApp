 ...
 * @author MustainE
 */
public class TrackingDao_Documento {
    DecimalFormat df = new DecimalFormat("#,###.00");
   
public static ArrayList<Tracking> listDetalleTrackingDocumento(
        ...
        try {
            ...
            PreparedStatement ps = accesoDB.prepareCall("{call SP_OBTENERTRACKINGACTUAL_DOCUMENTOS(?,?)}");
